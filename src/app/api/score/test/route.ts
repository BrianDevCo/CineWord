...
export async function GET() {
  ...
  const tests = {
    // SCOMAP sala 2 hoy — ver respuesta COMPLETA (especialmente el campo Estado)
    scomap_full: callScore(base, "scomap", JSON.stringify({ Sala: "2", FechaFuncion: hoy, Funcion: "20", teatro, tercero })),
  };
